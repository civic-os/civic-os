...
INSERT INTO metadata.categories (entity_type, display_name, color, sort_order) VALUES
  ...
  ('organization_type', 'Corporate', '#F59E0B', 4),
  ('organization_type', 'Foundation', '#EC4899', 5)
...
INSERT INTO metadata.statuses (entity_type, display_name, color, sort_order, is_initial, is_terminal) VALUES
  ('project', 'Planning', '#3B82F6', 1, TRUE, FALSE),
  ('project', 'Active', '#22C55E', 2, FALSE, FALSE),
  ('project', 'Completed', '#6B7280', 3, FALSE, TRUE),
  ('project', 'On Hold', '#F59E0B', 4, FALSE, FALSE),
  ('project', 'Cancelled', '#EF4444', 5, FALSE, TRUE)
ON CONFLICT DO NOTHING;
...
CREATE TABLE "public"."projects" (
	...
	"start_date" DATE,
	"end_date" DATE,
	"status_id" INT DEFAULT get_initial_status('project')
);
