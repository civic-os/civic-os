...
describe('StaticAssetsPage', () => {
    ...
    beforeEach(async () => {
        mockService = {
            getAll: vi.fn().mockName("StaticAssetsService.getAll"),
            create: vi.fn().mockName("StaticAssetsService.create"),
            update: vi.fn().mockName("StaticAssetsService.update"),
            delete: vi.fn().mockName("StaticAssetsService.delete"),
            getBySlug: vi.fn().mockName("StaticAssetsService.getBySlug"),
            getById: vi.fn().mockName("StaticAssetsService.getById"),
            uploadCroppedImage: vi.fn().mockName("StaticAssetsService.uploadCroppedImage"),
            hasStaticAssetAccess: vi.fn().mockName("StaticAssetsService.hasStaticAssetAccess")
        };
