...
describe('WidgetContainerComponent', () => {
    ...
    describe('widgetComponent computed signal', () => {
        ...
        it('should return null when widget type not registered', () => {
            vi.spyOn(console, 'error').mockReturnValue(undefined); // Suppress error log
        ...
        it('should log error when widget type not found', () => {
            ...
            expect(console.error).toHaveBeenCalledWith('[WidgetContainerComponent] No component registered for widget type: unknown_type');
        });
        ...
        it('should update when widget input changes to different type', () => {
            ...
            vi.spyOn(console, 'error').mockReturnValue(undefined); // Suppress error
