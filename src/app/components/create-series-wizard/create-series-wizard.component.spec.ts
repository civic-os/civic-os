...
describe('CreateSeriesWizardComponent', () => {
    ...
    beforeEach(async () => {
        ...
        mockRecurringService = {
            ...
            createSeries: vi.fn().mockName("RecurringService.createSeries")
        };

        mockSchemaService.getProperties.mockReturnValue(of(mockProperties));
    ...
    describe('buildTemplateForm', () => {
        ...
        it('should initialize boolean controls with false instead of null', () => {
            ...
            mockSchemaService.getProperties.mockReturnValue(of(propsWithBoolean));
            component.onEntityTypeChange();
    ...
    describe('datetime-local handling (v0.39.0 TIMESTAMP fix)', () => {
        it('createSeries sends datetime-local string directly without UTC conversion', () => {
            ...
            mockRecurringService.createSeries.mockReturnValue(of({
                success: true,
                group_id: 1,
                series_id: 1,
                message: 'Created'
            ...
            const params = vi.mocked(mockRecurringService.createSeries).mock.calls[0][0];
