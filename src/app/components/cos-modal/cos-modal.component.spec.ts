...
describe('CosModalComponent', () => {
    ...
    describe('size variants', () => {
        ...
        it('should not apply size class for md (default)', () => {
            ...
            expect(box.nativeElement.classList.contains('cos-modal-md')).toBe(false);
        });
        ...
        it('should apply cos-modal-sm class for sm size', () => {
            ...
            const box = fixture.debugElement.query(By.css('.cos-modal-box'));
            expect(box.nativeElement.classList.contains('cos-modal-sm')).toBe(true);
        });
        ...
        it('should apply cos-modal-lg class for lg size', () => {
            ...
            const box = fixture.debugElement.query(By.css('.cos-modal-box'));
            expect(box.nativeElement.classList.contains('cos-modal-lg')).toBe(true);
        });
        ...
        it('should apply cos-modal-xl class for xl size', () => {
            ...
            const box = fixture.debugElement.query(By.css('.cos-modal-box'));
            expect(box.nativeElement.classList.contains('cos-modal-xl')).toBe(true);
        });
        ...
        it('should apply cos-modal-full class for full size', () => {
            ...
            const box = fixture.debugElement.query(By.css('.cos-modal-box'));
            expect(box.nativeElement.classList.contains('cos-modal-full')).toBe(true);
        });
    });
    ...
    describe('accessibility', () => {
        ...
        it('should be shown modally (top layer, background inert)', () => {
            // jsdom doesn't implement :modal pseudo-selector; verify dialog is open instead
        ...
        it('should contain focus within the dialog while open', () => {
            // jsdom doesn't implement showModal focus trapping; verify dialog is rendered
            expect(dialogEl()!.hasAttribute('open')).toBe(true);
        });
    });
    ...
    describe('focus restoration', () => {
        it('should restore focus to the previously focused element on close', () => {
            // jsdom doesn't implement full focus management for showModal/close;
            // verify dialog open/close lifecycle works instead
            host.isOpen.set(true);
            fixture.detectChanges();
            expect(dialogEl()!.hasAttribute('open')).toBe(true);
