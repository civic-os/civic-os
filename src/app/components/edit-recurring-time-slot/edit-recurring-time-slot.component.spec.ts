...
describe('EditRecurringTimeSlotComponent', () => {
    ...
    beforeEach(async () => {
        mockRecurringService = {
            previewConflicts: vi.fn().mockName("RecurringService.previewConflicts"),
            describeRRule: vi.fn().mockName("RecurringService.describeRRule"),
            buildRRuleString: vi.fn().mockName("RecurringService.buildRRuleString"),
            parseRRuleString: vi.fn().mockName("RecurringService.parseRRuleString")
        };
        mockRecurringService.previewConflicts.mockReturnValue(of([]));
