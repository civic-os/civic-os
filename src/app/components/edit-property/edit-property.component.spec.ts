...
describe('EditPropertyComponent', () => {
    ...
    beforeEach(async () => {
        ...
        mockSchemaService = {
            ...
            getStatusesForEntity: vi.fn().mockName("SchemaService.getStatusesForEntity"),
            getCategoriesForEntity: vi.fn().mockName("SchemaService.getCategoriesForEntity"),
        ...
        mockSchemaService.getStatusesForEntity.mockReturnValue(of([]));
        mockSchemaService.getCategoriesForEntity.mockReturnValue(of([]));
    ...
    describe('Markdown Type', () => {
        ...
        it('should treat Markdown as a custom widget (no label[for])', () => {
            ...
            expect(component.isCustomWidget()).toBe(true);
        });
    });
    ...
    describe('ForeignKeyName Type', () => {
        it('should fetch dropdown options on init', async () => {
            const mockOptions = [
                { id: 1, display_name: 'Option 1', created_at: '', updated_at: '' },
                { id: 2, display_name: 'Option 2', created_at: '', updated_at: '' }
            ];

            mockDataService.getData.mockReturnValue(of(mockOptions as any));
        ...
        it('should include null option for nullable foreign keys', async () => {
            mockDataService.getData.mockReturnValue(of([{ id: 1, display_name: 'Option', created_at: '', updated_at: '' }] as any));
    ...
    describe('isControlInvalidAndTouched()', () => {
        it('should return false when control is valid', () => {
            ...
            expect(component.isControlInvalidAndTouched('name')).toBe(false);
        });
        ...
        it('should return true when control is invalid and touched', () => {
            ...
            expect(component.isControlInvalidAndTouched('name')).toBe(true);
        });
    });
    ...
    describe('Telephone validation highlighting', () => {
        it('should have blur event handler wired up to call onPhoneBlur', () => {
            ...
            vi.spyOn(component, 'onPhoneBlur').mockReturnValue(undefined);
    ...
    describe('Status validation styling helpers', () => {
        it('isControlInvalidAndTouched should be used by status select for conditional styling', () => {
            ...
            expect(component.isControlInvalidAndTouched('status_id')).toBe(true);
            ...
            expect(component.isControlInvalidAndTouched('status_id')).toBe(false);
        });
    });
    ...
    describe('Category (Rich Enum)', () => {
        ...
        describe('getSelectedCategoryColor()', () => {
            it('should return color of selected category', () => {
                const categoryProp = createMockProperty({
                    column_name: 'entry_type_id',
                    type: EntityPropertyType.Category,
                    category_entity_type: 'time_entry'
                });
                const formGroup = new FormGroup({
                    entry_type_id: new FormControl(1) // Clock In
                });
                fixture.componentRef.setInput('property', categoryProp);
                fixture.componentRef.setInput('formGroup', formGroup);
                component.ngOnInit();

                const color = component.getSelectedCategoryColor(mockCategoryOptions);
                expect(color).toBe('#22C55E');
            });
            ...
            it('should return null when selected category has no color', () => {
                const categoryProp = createMockProperty({
                    column_name: 'entry_type_id',
                    type: EntityPropertyType.Category,
                    category_entity_type: 'time_entry'
                ...
                const formGroup = new FormGroup({
                    entry_type_id: new FormControl(3) // No Color category
                });
                fixture.componentRef.setInput('property', categoryProp);
                fixture.componentRef.setInput('formGroup', formGroup);
                component.ngOnInit();
            ...
            it('should handle string category_id (from select element)', () => {
                const categoryProp = createMockProperty({
                    column_name: 'entry_type_id',
                    type: EntityPropertyType.Category,
                    category_entity_type: 'time_entry'
        ...
        describe('getSelectedCategoryBackgroundColor()', () => {
            it('should return rgba color with 15% opacity', () => {
                const categoryProp = createMockProperty({
                    column_name: 'entry_type_id',
                    type: EntityPropertyType.Category,
    ...
    describe('Options Source RPC (v0.44.0)', () => {
        ...
        it('should clear selection when dependency change removes current value from options', async () => {
            ...
            mockDataService.callRpc.mockReturnValue(of(filteredOptions));
        ...
        it('should NOT clear selection when FK search modal is used and value not in RPC options', async () => {
            ...
            mockDataService.getData.mockReturnValue(of([{ id: 99, display_name: 'Saved Borrower' }] as any));
    ...
    describe('FK Search Modal (v0.45.0)', () => {
        ...
        it('should render button (not select) when fk_search_modal is true', async () => {
            mockDataService.getData.mockReturnValue(of([{ id: 1, display_name: 'Test', created_at: '', updated_at: '' }] as any));
        ...
        it('should show display name on button when value is set', async () => {
            mockDataService.getData.mockReturnValue(of([{ id: 1, display_name: 'Open Status', created_at: '', updated_at: '' }] as any));
        ...
        it('should not update form on closed event (cancel)', () => {
            mockDataService.getData.mockReturnValue(of([{ id: 3, display_name: 'Existing', created_at: '', updated_at: '' }] as any));
    ...
    describe('Computed Column Filter (v0.53.0)', () => {
        ...
        it('should still call RPC when options_source_rpc is set without options_filter_column', () => {
            ...
            mockDataService.callRpc.mockReturnValue(of([{ id: 1, display_name: 'Item' }]));
