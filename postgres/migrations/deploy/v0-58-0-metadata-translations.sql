...
-- ============================================================================
-- 1i. SEED SPANISH METADATA TRANSLATIONS for pothole example
-- ============================================================================
-- Provides a working demo for Spanish-speaking users.

-- Entity display names
INSERT INTO metadata.translations (source_type, source_key, locale, translated_text) VALUES
('entity', 'Issue.display_name', 'es', 'Problemas'),
('entity', 'Issue.description', 'es', 'Problemas de baches reportados'),
('entity', 'Pot_Hole.display_name', 'es', 'Baches'),
('entity', 'Pot_Hole.description', 'es', 'Observaciones de baches'),
...
('entity', 'Inspector.description', 'es', 'Inspectores de baches'),
...
-- WorkPackage property display names
...
-- Inspector property display names
('property', 'Inspector.display_name.display_name', 'es', 'Nombre'),
('property', 'Inspector.created_at.display_name', 'es', 'Creado'),
('property', 'Inspector.updated_at.display_name', 'es', 'Actualizado'),
-- Tag property display names
...
-- Issue statuses (using auto-generated status_keys from display_name)
INSERT INTO metadata.translations (source_type, source_key, locale, translated_text) VALUES
...
-- ============================================================================
-- 1j. UPDATE schema_cache_versions VIEW
-- ============================================================================
