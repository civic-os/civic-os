-- Revert civic_os:v0-35-0-admin-notification-prefs from pg
...
DROP FUNCTION IF EXISTS public.admin_update_notification_preference(UUID, TEXT, BOOLEAN, BOOLEAN);
DROP FUNCTION IF EXISTS public.admin_get_user_notification_preferences(UUID);


-- ============================================================================
-- 2. DROP admin RLS policies and revoke grants on notification_preferences
-- ============================================================================

DROP POLICY IF EXISTS "Admin read all preferences" ON metadata.notification_preferences;
DROP POLICY IF EXISTS "Admin update all preferences" ON metadata.notification_preferences;
REVOKE SELECT, UPDATE ON metadata.notification_preferences FROM authenticated;


-- ============================================================================
-- 3. RESTORE managed_users VIEW (v0.31.0-edit-user-info version, without notification columns)
-- ============================================================================
...
-- ============================================================================
-- 4. RESTORE schema_functions VIEW (v0.31.0-edit-user-info version)
-- ============================================================================
