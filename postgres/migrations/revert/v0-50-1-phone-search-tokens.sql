-- Revert civic_os:v0-50-1-phone-search-tokens from pg
...
-- ============================================================================
-- 2. RESTORE civic_os_users VIEW (v0-49-1 version, without phone_search_tokens)
-- ============================================================================
...
-- ============================================================================
-- 5. DROP phone_search_tokens function
-- ============================================================================

DROP FUNCTION IF EXISTS public.phone_search_tokens(phone_number);
