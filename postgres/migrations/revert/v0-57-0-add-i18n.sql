-- Revert civic_os:v0-57-0-add-i18n from pg
-- Removes i18n foundation: translations table, lookup functions, locale column,
-- and restores civic_os_users VIEW to pre-i18n state.
...
DROP FUNCTION IF EXISTS public.get_missing_translations(TEXT);
DROP FUNCTION IF EXISTS public.upsert_translations(JSONB);
DROP FUNCTION IF EXISTS public.get_translations_for_locale(TEXT);


-- ============================================================================
-- 2. Drop translations VIEW
-- ============================================================================
...
-- ============================================================================
-- 3. Drop translation functions
-- ============================================================================

DROP FUNCTION IF EXISTS metadata.t(TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS metadata.current_locale();


-- ============================================================================
-- 4. Restore civic_os_users VIEW without locale column
-- ============================================================================
-- DROP CASCADE also removes payment_transactions and payment_refunds.
-- All three views must be recreated.

DROP VIEW IF EXISTS public.civic_os_users CASCADE;

-- Restore VIEW definition from v0-55-2-submit-form-status-fix (without locale)
...
-- Restore payment_transactions VIEW (dropped by CASCADE)
...
-- Restore payment_refunds VIEW (dropped by CASCADE)
...
-- ============================================================================
-- 5. Remove locale column from civic_os_users_private
-- ============================================================================

ALTER TABLE metadata.civic_os_users_private DROP COLUMN IF EXISTS locale;


-- ============================================================================
-- 6. Drop translations table (also drops trigger, index, RLS policies)
-- ============================================================================

DROP TABLE IF EXISTS metadata.translations;
