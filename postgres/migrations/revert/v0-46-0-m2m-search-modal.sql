-- Revert civic_os:v0-46-0-m2m-search-modal from pg

BEGIN;

-- 1. DROP schema_m2m_properties VIEW (v0.46.0)
...
ALTER TABLE metadata.properties DROP CONSTRAINT IF EXISTS show_inline_requires_m2m;
ALTER TABLE metadata.properties DROP COLUMN IF EXISTS show_inline;

-- 4. RECREATE schema_properties VIEW (v0.45.0 version, without show_inline)
...
-- 5. RECREATE schema_entity_dependencies VIEW (v0.45.0 version)
