...
-- ============================================================================
-- 1. DROP schema_entities CASCADE (dependents: schema_properties, schema_entity_dependencies)
-- ============================================================================
-- PG cannot remove columns via CREATE OR REPLACE VIEW, so we must DROP + recreate.
-- CASCADE drops dependent views which must be recreated below.

DROP VIEW IF EXISTS public.schema_entities CASCADE;

-- ============================================================================
-- 2. RECREATE schema_entities WITHOUT is_rich_junction
-- ============================================================================
...
-- ============================================================================
-- 3. RECREATE schema_properties (dropped by CASCADE)
-- ============================================================================
-- Definition from v0-46-0-m2m-search-modal (latest migration defining this view)
...
-- ============================================================================
-- 4. RECREATE schema_entity_dependencies (dropped by CASCADE)
-- ============================================================================
